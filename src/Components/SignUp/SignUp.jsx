...
export default function SignUp() {
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-auto items-center">
      <Header />
      <div className="w-full rounded-lg flex items-center justify-center h-full p-20 bg-neutral-100/30">
        {/* <div className="w-full bg-blue-200 h-full flex justify-center items-center">
          <img src={Slide1} className=" m-auto h-96 w-96" />
        </div> */}
        <div className="flex  w-full gap-6 pt-10 h-full  overflow-auto justify-center items-center my-20 bg-white shadow-class rounded-2xl">
          <div className="w-full  mx-auto flex flex-col px-20   gap-6 h-full">
            <div className="flex">
