        ...
        <div class="row">
          <div class="col-12">
            <div class="banner-inner">
              ...
              <div className="absolute z-30 -bottom-24 hover:scale-105 transition-all ease-in-out duration-500 w-[89vw]  md:mx-0 md:max-w-[550px] xl:max-w-[650px]  2xl:max-w-[700px]">
                {" "}
                <Form />
              </div>
            </div>
