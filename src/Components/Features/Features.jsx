...
export default function Features() {
  return (
    <div className="main-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:items-stretch items-center  gap-8 md:gap-3 justify-between pt-32 lg:pt-52">
